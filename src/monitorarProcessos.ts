...
interface MonitorarProcessosParams {
  numeroProcesso: string;
  tribunal?: string;
}

async function monitorarProcessos(params: MonitorarProcessosParams): Promise<void> {
  try {
    ...
    console.log(`Executando monitorarProcessos com numeroProcesso=${params.numeroProcesso}...`);
    ...
    const resultado = {
      ...
      status: "sucesso",
      mensagem: "Monitora novos andamentos de processos concluído com sucesso",
      resultado: {
...
export default monitorarProcessos;
