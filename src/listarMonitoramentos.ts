...
interface ListarMonitoramentosParams {
  parametro: string;
  filtro?: string;
}

async function listarMonitoramentos(params: ListarMonitoramentosParams): Promise<void> {
  try {
    ...
    console.log(`Executando listarMonitoramentos com parametro=${params.parametro}...`);
    ...
    const resultado = {
      ...
      status: "sucesso",
      mensagem: "Lista processos em monitoramento concluído com sucesso",
      resultado: {
...
export default listarMonitoramentos;
